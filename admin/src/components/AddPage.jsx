...
const AddPage = () => {
  ...
  // it resests the fields once the data get submited
...
function Uploader({title,onFiles,items,remove,icon,updateMeta, id}){
  return(
    <div className={addMoviePageStyles.uploaderContainer}>
      ...
      <label htmlFor={id} className={addMoviePageStyles.uploaderAddButton}>
        + Add
        <input type="file" multiple accept='image/*' onChange={onFiles} className={addMoviePageStyles.uploaderAddInput} id={id} />
      </label>
      ...
      items.map((it,idx)=>(
        <div key={idx} className={addMoviePageStyles.uploaderItem}>
          ...
          {typeof it.name!=="undefined" && (
            <div className='mt-2'>
              <input value={it.name} type="text" onChange={(e)=>
           ...
           {typeof it.role!=="undefined" && (
            <div className='mt-2'>
              <input value={it.role} type='text' onChange={(e)=>
...
// for latestTrailer function Nameuploader

function NamedUploader({title,onFiles,items,remove,updateName,icon, id}){
  return (
      <div className={addMoviePageStyles.uploaderContainer}>
      <div className={addMoviePageStyles.uploaderHeader}>
        <div className={addMoviePageStyles.uploaderTitle}>
    ...
    <div className={addMoviePageStyles.namedUploaderGrid}>
      {items && items.length ?(
      items.map((it,idx)=>(
        <div key={idx} className={addMoviePageStyles.nameUploaderItem}>
