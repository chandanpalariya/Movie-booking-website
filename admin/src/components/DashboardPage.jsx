...
const DashboardPage = () => {
  ...
  // this function fateches the number and booking related thing from the backend
      ...
      <div className={styles3.maxWidthContainer}>
        <header className={styles3.dashboardHeaderContainer}>
          <div>
            ...
            <p className={styles3.dashboardSubtitle}>Overview of paid bookings,revenue and users </p>
          </div>
        </header>
        ...
        <section className={styles3.summaryGrid}>
          ...
          {/*  */}
            ...
            <div className={styles3.summaryNote}>Paid bookings summary</div>
          ...
          <div className={styles3.summaryCard}>
            ...
            <div className={styles3.summaryNote}>Register of booking Users</div>
            ...
            <table className={styles3.table}>
              ...
              <tbody>
                {summary.movieStats.map((m)=>{
                  const avg=m.bookings ? Math.round(m.earnings/m.bookings)
                  :0;
                  return (
                    <tr key={m.id} className={styles3.tableRow}>
                      <td className={styles3.tableCell}>
                        <div className={styles3.tableMovieTitle}>
                          {m.title}
