...
import {styles4} from "../assets/dummyStyle"
import {Calendar,Copy,Film,List,Menu,Ticket,X,X as XIcon } from 'lucide-react';
        ...
        <div className={`${styles4.mobileMenuContainer} ${
          ...
          <aside id='mobile-menu' className={`${styles4.mobileMenuPanel} ${
            ...
            <div className={styles4.mobileMenuPanelHeader}>
              <div className={styles4.logoContainer}>
                <div className='flex items-center justify-center w-10 h-20 bg-red-600 rounded-full transform rotate-12'>
            ...
            <nav className={styles4.mobileMenuPanelNav}>
              ...
              >
                {
                  ({isActive})=>(
               <>
                <Film className={`${styles4.mobileNavLinkBase} ${
               ...
               <NavLink to="/listmovies" end onClick={close} className={({isActive})=>`${styles4.mobileNavLinkBase} ${isActive ? styles4.mobileNavLinkActive :styles4.mobileNavLinkInactive}`} 
              >
                {
                  ({isActive})=>(
               <>
                <List className={`${styles4.mobileNavLinkBase} ${
                  isActive ? styles4.mobileNavLinkIconActive : styles4.mobileNavLinkIconInactive
                } `}
                />
               ...
               <NavLink to="/bookings" end onClick={close} className={({isActive})=>`${styles4.mobileNavLinkBase} ${isActive ? styles4.mobileNavLinkActive :styles4.mobileNavLinkInactive}`} 
              >
                {
                  ({isActive})=>(
               <>
                <Ticket className={`${styles4.mobileNavLinkBase} ${
                  isActive ? styles4.mobileNavLinkIconActive : styles4.mobileNavLinkIconInactive
                } `}
                />
              ...
              <NavLink to="/Dashbord" end onClick={close} className={({isActive})=>`${styles4.mobileNavLinkBase} ${isActive ? styles4.mobileNavLinkActive :styles4.mobileNavLinkInactive}`} 
              >
                {
                  ({isActive})=>(
               <>
                <Calendar className={`${styles4.mobileNavLinkBase} ${
                  isActive ? styles4.mobileNavLinkIconActive : styles4.mobileNavLinkIconInactive
                } `}
                />
