...
import {bookingsPageStyles,formatTime,formatDuration} from "../assests/dummyStyles"
import  QRCode  from "qrcode"
import axios from 'axios'
import { useEffect,useState } from 'react'
import { useNavigate } from 'react-router-dom'
import {Film,Clock,MapPin,QrCode as QrCodeIcon,ChevronDown,X} from "lucide-react"
                  ...
                  >
                    ...
                    <div className={bookingsPageStyles.qrSection}>
                      <div className={bookingsPageStyles.qrLabel}>
                        <QrCodeIcon className={bookingsPageStyles.qrIcon} />
                        <div>Ticket QR</div>
                      </div>
