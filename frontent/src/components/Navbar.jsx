...
import { navbarCSS, navbarStyles } from "../assests/dummyStyles.js";
...
//it will open the menu for smaller screen and also closes when escape key is present
        ...
        <div className={navbarStyles.desktopNav}>
          <div className={navbarStyles.desktopNavItems}>
            {navItems.map((item) => {
              ...
              return (
                <div key={`desktop-${item.id}`} className={navbarStyles.desktopNavItem}>
                  <NavLink
                    to={item.path}
                    end
                    className={({ isActive }) =>
          ...
          <div ref={menuRef} className={navbarStyles.mobileMenuPanel}>
            <div className={navbarStyles.mobileMenuItems}>
             {navItems.map((item) => {
              const Icon = item.icon;
              return (
                <div key={`mobile-${item.id}`} className={navbarStyles.desktopNavItem}>
                  <NavLink
                    to={item.path}
                    end
                    className={({ isActive }) =>
