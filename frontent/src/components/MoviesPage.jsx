              ...
              <section className={moviesPageStyles.moviesSection}>
                <div className={moviesPageStyles.moviesContainer}>
                  <div className={moviesPageStyles.moviesGrid}>
                    {visibleMovies.map((movie) => (
                      ...
                      >
                        <div
                          className={
                            moviesPageStyles.movieImageContainer
                          }
                        >
                          <img
                            src={movie.image}
                        ...
                        <div className={moviesPageStyles.movieInfo}>
                          <h3
                            className={moviesPageStyles.movieTitle}
                          >
                            {movie.title}
                          </h3>
                          ...
                          <div
                            className={
                              moviesPageStyles.movieCategory
                            }
                          >
                            <span
                              className={
                                moviesPageStyles.movieCategoryText
                              }
                            >
                              {movie.category}
                            </span>
                  ...
                  {filteredMovies.length > COLLAPSE_COUNT && (
                    <div
                      className={
                        moviesPageStyles.showMoreContainer
                      }
                    >
                      <button
                        onClick={() =>
                        ...
                        className={
                          moviesPageStyles.showMoreButton
                        }
                        type="button"
                      >
                        {showAll
